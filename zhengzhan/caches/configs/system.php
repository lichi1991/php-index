...
'cookie_pre' => 'imdTn_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'https://limbobark.duapp.com/zhengzhan/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'https://limbobark.duapp.com/zhengzhan/statics/js/', //CDN JS
'css_path' => 'https://limbobark.duapp.com/zhengzhan/statics/css/', //CDN CSS
'img_path' => 'https://limbobark.duapp.com/zhengzhan/statics/images/', //CDN img
'app_path' => 'https://limbobark.duapp.com/zhengzhan/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => '6rgUHGLUcQpLGoxl9Anb', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'https://limbobark.duapp.com/zhengzhan/phpsso_server',	//接口地址
'phpsso_auth_key' => 'at9v8H8mYtyL0iAm6L5S0qKygdochg7Y', //加密密钥
